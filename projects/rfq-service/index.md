...
Чтобы решить проблему, мы решили сделать для поставщиков веб-приложение. Оно было задумано предельно простым (чтобы поставщиков не нужно было обучать).

## 💪 Действия

Мы разделили решение на две части: доработку конфигурации 1С (создание запросов на проценку + приём ответов на запросы) и разработку веб-приложения (собственно, сам интерфейс проценки).
