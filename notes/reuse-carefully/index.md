---
title: Переиспользуйте с осторожностью
description: При работе с модулями, у которых включено переиспользование возвращаемых
  значений, можно ляпнуть неприятную ошибку.
