---
title: Проблема с литералом даты при пересчете итогов
description: 'Краткая инструкция: почему возникает проблема с литералом даты при пересчете
  итогов и как с ней бороться.'
