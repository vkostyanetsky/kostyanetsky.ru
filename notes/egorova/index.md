...
Проблеме сто лет (ну ладно, четыре года) и она существует для множества языков. Русский, кстати, [выбивается](https://github.com/openai/whisper/discussions/928#discussioncomment-5372187) из общего ряда — если условный итальянец страдает от скучного «Субтитры созданы сообществом Amara.org», то у нас, так сказать, свой фэндом.
