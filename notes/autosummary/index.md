---
title: Автосаммари
description: Про то, как можно автоматизировать генерацию саммари по итогам встреч.
...
Вот, в общем-то, и весь метод. Остаётся написать простой скрипт, чтобы не дергать две команды вручную. Если вы тоже на Windows и вам лень вайбкодить, можете взять [мой скрипт](https://gist.github.com/vkostyanetsky/4f4760097f1b417cc85d71d11662a642) и подогнать под себя.
